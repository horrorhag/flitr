...
namespace flitr
{
    class MultiWebRTCConsumer;
    
    class MultiWebRTCConsumerThread : public OpenThreads::Thread
    {
    public:
        MultiWebRTCConsumerThread(MultiWebRTCConsumer *consumer) :
        _consumer(consumer),
        _shouldExit(false) {}
        void run();
    ...
    private:
        ...
        MultiWebRTCConsumer *_consumer;
        bool _shouldExit;
    };
    
    class FLITR_EXPORT MultiWebRTCConsumer : public ImageConsumer
    {
        friend class MultiWebRTCConsumerThread;
    public:
        
        MultiWebRTCConsumer(ImageProducer& producer, const uint32_t imagesPerSlot);
        
        virtual ~MultiWebRTCConsumer();
    ...
    private:
        ...
        MultiWebRTCConsumerThread *_thread;
