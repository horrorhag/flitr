...
GLSLDownsampleYPass::GLSLDownsampleYPass(osg::TextureRectangle *in_tex, int dsfactor, bool read_back_to_CPU)
{
...
GLSLDownsampleYPass::~GLSLDownsampleYPass()
{
}

osg::ref_ptr<osg::Group> GLSLDownsampleYPass::createTexturedQuad()
{
...
void GLSLDownsampleYPass::setupCamera()
{
    // clearing
...
void GLSLDownsampleYPass::createOutputTexture(bool read_back_to_CPU)
{
...
void GLSLDownsampleYPass::setShader()
{
