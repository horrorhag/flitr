...
#ifndef GLSL_TRANSLATE_PASS_H
#define GLSL_TRANSLATE_PASS_H 1
#include <iostream>
#include <string>
...
{
  public:
    GLSLTranslatePass(osg::TextureRectangle *in_tex, bool read_back_to_CPU = false);
    ~GLSLTranslatePass();
  ...
  private:
    ...
    osg::ref_ptr<osg::Uniform> UniformTranslation_;
};
}
#endif //GLSL_TRANSLATE_PASS_H
