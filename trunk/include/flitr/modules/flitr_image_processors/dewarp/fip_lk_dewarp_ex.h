...
#ifndef FIP_LK_DEWARP_EX_H
#define FIP_LK_DEWARP_EX_H 1
...
namespace flitr {
    ...
    class FLITR_EXPORT FIPLKDewarpEx : public ImageProcessor
    {
    public:
        ...
        FIPLKDewarpEx(ImageProducer& upStreamProducer, uint32_t images_per_slot,
                    const float avrgImageLongevity,
                    uint32_t buffer_size=FLITR_DEFAULT_SHARED_BUFFER_NUM_SLOTS);
        
        /*! Virtual destructor */
        virtual ~FIPLKDewarpEx();
