...
GLSLDownsampleXPass::~GLSLDownsampleXPass()
{
}

osg::ref_ptr<osg::Group> GLSLDownsampleXPass::createTexturedQuad()
{
...
void GLSLDownsampleXPass::setupCamera()
{
    // clearing
...
void GLSLDownsampleXPass::setShader()
{
    osg::ref_ptr<osg::Shader> fshader = new osg::Shader( osg::Shader::FRAGMENT,
                                                         ...
                                                         "    {\n"
                                                         "       c  += texture2DRect(textureID0, texCoord+vec2(float(i),0));\n"
                                                         "    }\n"
    ...
    FragmentProgram_->setName("glsl_downsample_x");
