...
GLSLCopyPass::~GLSLCopyPass()
{
}

osg::ref_ptr<osg::Group> GLSLCopyPass::createTexturedQuad()
{
...
void GLSLCopyPass::createOutputTexture(bool read_back_to_CPU)
{
